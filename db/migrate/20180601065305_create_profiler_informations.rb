class CreateProfilerInformations < ActiveRecord::Migration[4.2]
  def change
    create_table :profiler_informations do |t|
      ...
      name: "index_profiler_informations_on_record_type_and_id"
      t.index %i[type content label record_type record_id],
      name: "index_profiler_informations_uniqueness", unique: true
